...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    price: 8.50,
    category: 'Breakfast Specials',
    description: 'Vibrant medley of stir-fried seasonal garden veggies, grilled tomatoes, fresh avocado, and sourdough.',
  ...
  },
  {
    ...
    price: 5.50,
    category: 'Soups',
    description: 'A rich, velvety soup roasted to perfection and garnished with fresh green garden herbs.',
  ...
  },
  {
    ...
    description: 'A aromatic, gentle curry with tender sweet potato slices, local spices, and coconut milk.',
  ...
  },
  {
    ...
    description: 'Tender chicken strips tossed in our house mild-curry coronation cream, rolled in a toasted tortilla.',
  ...
  },
  {
    ...
    description: 'Rich crumbled goat cheese over a vibrant bed of fresh greenhouse greens and house vinaigrette.',
...
export const EVENTS: CafeEvent[] = [
  {
    ...
    category: 'Arts & Music',
    description: 'Enjoy acoustic live sets and heartwarming local poetry nested under our beautiful indoor greenhouse canopy.',
  ...
  {
    id: 'evt-002',
    title: 'Botanical Illustration & Terrariums',
  ...
  {
    id: 'evt-003',
    title: 'Biophilia & Urban Conservation Forum',
    date: 'Tuesday, June 23, 2026',
    time: '7:00 PM - 8:30 PM',
    category: 'Nature',
    description: 'Open panel with local biologists regarding sustainable, organic urban rewilding and micro-composting.',
